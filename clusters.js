  ...
  const nodeNautobotMetaMarkup = nodeNautobotInfo.url
    ? `
      <div class="node-nautobot-meta" data-nautobot-meta>
        ...
        <a href="${nodeNautobotInfo.url}" class="nautobot-presence-link" data-nautobot-link-icon target="_blank" rel="noopener noreferrer" aria-label="${sanitizeHTML(nodeNautobotInfo.title)}">
  ...
  const vmNautobotMetaMarkup = nautobotInfo.url
    ? `
      <div class="vm-nautobot-meta" data-nautobot-meta>
        ...
        <a href="${nautobotInfo.url}" class="nautobot-presence-link" data-nautobot-link-icon target="_blank" rel="noopener noreferrer" aria-label="${sanitizeHTML(nautobotInfo.title)}">
